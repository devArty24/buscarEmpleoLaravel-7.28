...
<template>
    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full" :class="claseEstadoVacante()" @click="cambiarEstado">
        {{estadoVacante}}
    </span>
</template>
    ...
    export default {
        ...
        methods:{
            ...
            cambiarEstado(){
                ...
                /* Enviar a axios */
                const params={estado:this.estadoVacanteData}
