    ...
    @if(count($notificaciones) > 0)
        <ul class="max-w-md mx-auto mt-10">
            @foreach ($notificaciones as $notificacion)
                ...
                @endphp
                <li class="p-5 border border-gray-400 mb-4">
                    <p class="mb-4">
                    ...
                    <a href="{{route("candidatos.index",["id"=> $data["id_vacante"]])}}" class="bg-teal-500 p-3 inline-block text-xs font-bold uppercase text-white mb-4">
                        Ver candidatos
                    </a>
                </li>
            @endforeach
